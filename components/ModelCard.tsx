      ...
      <div className="p-3 md:p-4 flex-grow flex flex-col text-right">
        ...
        <div className="mt-auto pt-2 md:pt-4 border-t border-white/5 space-y-2">
          <div className="flex flex-col items-end mb-1">
            {model.price === 0 ? (
              <span className="text-[10px] md:text-sm font-bold text-cyan-400">להצעת מחיר צרו קשר</span>
            ) : (
              <>
          ...
          <div className="flex flex-col gap-1.5">
            {model.price === 0 ? (
              <button 
                ...
                className="w-full py-1.5 md:py-2.5 bg-[#25D366] hover:bg-[#20bd5c] rounded-lg md:rounded-xl text-[9px] md:text-xs font-bold text-white transition-all shadow-md active:scale-95 flex items-center justify-center gap-1"
              >
