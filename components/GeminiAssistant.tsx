...
const GeminiAssistant: React.FC = () => {
  ...
  const handleSend = async () => {
    ...
    const updatedHistory = [...messages, { role: 'user', message: userMsg }] as {role: 'user' | 'model', message: string}[];
    ...
    <div className="fixed bottom-4 left-4 md:bottom-6 md:left-6 z-[60] flex flex-col items-center">
      {isOpen ? (
        ...
        <div className="relative group flex flex-col items-center">
          ...
          <div className="absolute -top-10 md:-top-14 left-1/2 -translate-x-1/2 w-10 h-10 md:w-20 md:h-20 transition-all duration-500 transform group-hover:-top-16 group-hover:scale-110 pointer-events-none animate-bounce-slow">
