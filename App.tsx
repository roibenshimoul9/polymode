  ...
  return (
    <Router>
      <div className="min-h-screen flex flex-col text-right">
        <Navbar onCartToggle={() => setIsCartOpen(true)} cartCount={cart.reduce((a, b) => a + b.quantity, 0)} />
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row-reverse justify-between items-center gap-8 text-center md:text-right">
            <div className="space-y-4">
              <div className="flex items-center justify-center md:justify-start space-x-2 space-x-reverse">
                ...
                <div className="relative w-12 h-12 flex items-center justify-center">
                  <svg viewBox="0 0 120 120" className="w-full h-full drop-shadow-[0_5px_15px_rgba(59,130,246,0.3)] overflow-visible">
                    ...
                    <g transform="translate(10, 20)">
                       ...
                       <path d="M30 25 Q60 0 90 25" fill="white" />
                       <circle cx="48" cy="20" r="4" fill="#111" />
                ...
                <span className="font-black tracking-widest text-xl uppercase bg-gradient-to-l from-white to-gray-400 bg-clip-text text-transparent">Polymode</span>
              </div>
            ...
            <div className="flex flex-wrap justify-center gap-8 text-[10px] font-semibold text-gray-500 uppercase tracking-[0.2em]">
              <a href="#" className="hover:text-blue-400 transition-colors">מדריך הדפסה פיזית</a>
              <a href="#" className="hover:text-white transition-colors">רישיונות דיגיטליים</a>
              <a href="#" className="hover:text-white transition-colors">מדיניות פרטיות</a>
              <a href="#" className="hover:text-white transition-colors border-r border-white/10 pr-8">קהילת דיסקורד</a>
            </div>
          </div>
        </footer>
