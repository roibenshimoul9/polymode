...
import ReturnsPage from './components/ReturnsPage.tsx';
...
const CATEGORIES: Category[] = ['הכל', 'דגמים ודמויות תלת־ממד', 'יודאיקה ולבית', 'מוצרים לרכב', 'פידג\'טים', 'אביזרים', 'בעלי חיים', 'DIY'];
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li><a href="https://wa.me/972546843548" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">תמיכה ושירות לקוחות</a></li>
              </ul>

              <h4 className="text-base font-bold mt-8 mb-4 text-white tracking-wider">טלגרם (Telegram)</h4>
              <ul className="space-y-3 text-sm text-gray-400">
                <li className="flex items-center gap-2 justify-start">
                  <svg className="w-4 h-4 text-blue-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.96-.65-.34-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .38z"/></svg>
                  <a href="https://t.me/POLYMODE3DBOT" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
                    אתר לתמיכה אישית וקטלוג
                  </a>
                </li>
                <li className="flex items-center gap-2 justify-start">
                  <svg className="w-4 h-4 text-blue-400 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.96-.65-.34-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .38z"/></svg>
                  <a href="https://t.me/+K04URryHB1Q5ZTU0" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">
                    ערוץ עדכונים ומוצרים בטלגרם
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400 flex flex-col items-start border-none">
                <li className="flex items-center gap-2" dir="ltr">
                  ...
                  <a href="https://wa.me/972546843548" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">054-684-3548</a>
                </li>
                <li className="flex items-center gap-2" dir="ltr">
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  <a href="mailto:polymode3d@gmail.com" className="hover:text-blue-400 transition-colors">polymode3d@gmail.com</a>
                </li>
                <li className="flex items-center gap-2" dir="ltr">
                  ...
                  <a href="https://wa.me/972546843548" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">WhatsApp</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li><Link to="/shipping" className="hover:text-blue-400 transition-colors">משלוחים וזמני אספקה</Link></li>
                <li><Link to="/returns" className="hover:text-blue-400 transition-colors">מדיניות החזרות וביטולים</Link></li>
              </ul>
              
              <div className="mt-8 flex items-center gap-4">
                <a href="https://www.facebook.com/profile.php?id=61585997738460&locale=he_IL" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Facebook">
                ...
                <a href="https://t.me/+K04URryHB1Q5ZTU0" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Telegram">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.96-.65-.34-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 00-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .38z"/></svg>
                </a>
                <a href="https://www.instagram.com/polymode.3d/#" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
